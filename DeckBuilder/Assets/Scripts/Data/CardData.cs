...
public class CardData : ScriptableObject
{
    ...
    [field: SerializeField] public bool Retain { get; private set; } = false;
    ...
    [field: SerializeField] public CardData CardReference { get; private set; }
    ...
    [field: SerializeField] public bool JustHighlightCard { get; private set; }
    ...
    [field: SerializeField] public List<CardReaction> AnywhereReactions { get; private set; } = null;
    [field: SerializeField] public List<CardReaction> InHandReactions { get; private set; } = null;
}
