...
public class SetStatusEffectGA : GameAction, IHaveCaster
{
    ...
    public SetStatusEffectGA(StatusEffectInfo statusEffectInfo, int stackCount, List<CombatantView> targets, EffectContext context, bool skipAnimation = false)
    {
